...
{
    [Serializable]
    public sealed class InterstitialPlacementDefinitionSpec : DeucarianDefinitionSpec
    {
        ...
        [DefinitionField("blockDuringCombat")] public bool BlockDuringCombat = true;
        [DefinitionField("blockWithNoAds")] public bool BlockWithNoAds = true;
    }
}
