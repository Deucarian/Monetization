# Monetization: definition workflow
...
3. Use its buttons to exercise show rewarded mock, retry same opportunity, new opportunity, show interstitial mock.
4. Inspect the configured hosts and triggers, then open
   [MonetizationWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/MonetizationWorkflow.cs). It is the caller
...
- **Show rewarded mock**: `MonetizationWorkflow.ShowRewarded()`.
- **Retry same opportunity**: `MonetizationWorkflow.ShowRewarded()`.
- **New opportunity**: `MonetizationWorkflow.NewOpportunity()`.
- **Show interstitial mock**: `MonetizationWorkflow.ShowInterstitial()`.
